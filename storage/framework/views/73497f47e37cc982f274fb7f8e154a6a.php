...
<?php $__env->startSection('title', 'Cek Hoaks - HoaxChecker Indonesia'); ?>
        ...
        <div class="p-8">
            ...
            <div class="mb-6 p-4 rounded-xl" style="background: rgba(239,68,68,0.08); border: 1px solid rgba(239,68,68,0.25);">
                ...
                <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <p class="text-xs text-red-600 dark:text-red-400 ml-6">• <?php echo e($error); ?></p>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            <?php endif; ?>

            
            <form method="POST" action="<?php echo e(route('hoax.analyze')); ?>" id="hoaxForm">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-8">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <?php $__currentLoopData = ['Semua', 'Politik', 'Kesehatan', 'Teknologi', 'Bencana', 'Sosial', 'Ekonomi']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="cursor-pointer">
                            <input type="radio" name="category" value="<?php echo e($cat); ?>" class="sr-only peer" <?php echo e($cat === 'Semua' ? 'checked' : ''); ?>>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$num, $title, $desc, $icon]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="card p-5 rounded-xl">
            <div class="flex items-center gap-3 mb-3">
                <div class="w-8 h-8 rounded-lg flex items-center justify-center text-xs font-black text-ink-900"
                     style="background: linear-gradient(135deg, #D4AF37, #F0D060);"><?php echo e($num); ?></div>
                <span class="text-xl"><?php echo e($icon); ?></span>
            </div>
            <h4 class="font-bold text-ink-800 dark:text-ink-200 mb-1 text-sm"><?php echo e($title); ?></h4>
            <p class="text-xs text-ink-500 dark:text-ink-400 leading-relaxed"><?php echo e($desc); ?></p>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Laporan Tugas Kuliah\SEMESTER 4\Pemrograman Web Lanjut\hoaxchecker\resources\views/hoax/check.blade.php ENDPATH**/ ?>