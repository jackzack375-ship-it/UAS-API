...
<?php $__env->startSection('title', 'Video Edukasi'); ?>
...
<div class="space-y-8">
    ...
    <form action="<?php echo e(route('education.videos')); ?>" method="GET">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <?php $__empty_1 = true; $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <div class="card overflow-hidden group">
                ...
                <div class="p-5">
                    ...
                    <p class="text-xs text-ink-400 line-clamp-2 mb-3 leading-relaxed"><?php echo e($snippet['description']); ?></p>
                    <p class="text-xs text-ink-300 font-mono">
                        <?php echo e(\Carbon\Carbon::parse($snippet['publishedAt'])->diffForHumans()); ?>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div class="col-span-3 card p-16 text-center">
                ...
                <p class="text-sm text-ink-400">Tidak ada video untuk "<span class="font-medium text-ink-600 dark:text-ink-300"><?php echo e($query); ?></span>".</p>
            </div>
        <?php endif; ?>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Laporan Tugas Kuliah\SEMESTER 4\Pemrograman Web Lanjut\hoaxchecker\resources\views/education/videos.blade.php ENDPATH**/ ?>