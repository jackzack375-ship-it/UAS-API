<?php $__env->startSection('title', 'Daftar - HoaxChecker Indonesia'); ?>
...
$message = $__bag->first($__errorArgs[0]); ?><p class="mt-1.5 text-xs text-red-500 dark:text-red-400"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" name="email" id="email" value="<?php echo e(old('email')); ?>" required autocomplete="username"
...
unset($__errorArgs, $__bag); ?>
            ...
            <p class="mt-6 text-center text-sm text-ink-500 dark:text-ink-400">
                Sudah punya akun?
                <a href="<?php echo e(route('login')); ?>" class="font-bold hover:underline ml-1" style="color: var(--gold);">Masuk Di Sini</a>
            </p>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Laporan Tugas Kuliah\SEMESTER 4\Pemrograman Web Lanjut\hoaxchecker\resources\views/auth/register.blade.php ENDPATH**/ ?>