...
<?php $__env->startSection('title', 'Login - HoaxChecker Indonesia'); ?>
    ...
    <div class="relative z-10 w-full max-w-md">
        ...
        <div class="card rounded-3xl p-8 md:p-10 shadow-2xl"
            ...
            <div class="mb-6 p-4 rounded-2xl flex items-center gap-2"
                ...
                <p class="text-sm text-emerald-700 dark:text-emerald-300"><?php echo e(session('status')); ?></p>
            </div>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Laporan Tugas Kuliah\SEMESTER 4\Pemrograman Web Lanjut\hoaxchecker\resources\views/auth/login.blade.php ENDPATH**/ ?>