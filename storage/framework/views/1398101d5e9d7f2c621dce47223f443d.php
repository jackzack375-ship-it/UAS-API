...
<div class="min-h-screen flex items-center justify-center px-4 py-12 relative overflow-hidden">
    ...
    <div class="relative z-10 text-center max-w-md">
        ...
        <!-- CTA Buttons -->
        <div class="space-y-3">
            <a href="<?php echo e(route('home')); ?>" class="block px-8 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-bold rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300">
                Kembali ke Beranda
            </a>
            <a href="<?php echo e(route('hoax.check')); ?>" class="block px-8 py-3 bg-white/10 dark:bg-white/5 border-2 border-white/20 text-gray-800 dark:text-white font-bold rounded-xl hover:bg-white/20 dark:hover:bg-white/10 transition-all duration-300">
                Cek Berita Sekarang
            </a>
        </div>
        ...
        <div class="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
            ...
            <div class="grid grid-cols-2 gap-2">
                <a href="<?php echo e(route('news.index')); ?>" class="text-sm text-indigo-600 dark:text-indigo-400 hover:underline">📰 Berita</a>
                <a href="<?php echo e(route('education.index')); ?>" class="text-sm text-indigo-600 dark:text-indigo-400 hover:underline">🎓 Edukasi</a>
                <a href="<?php echo e(route('history.index')); ?>" class="text-sm text-indigo-600 dark:text-indigo-400 hover:underline">📜 Riwayat</a>
                <a href="<?php echo e(route('contact')); ?>" class="text-sm text-indigo-600 dark:text-indigo-400 hover:underline">📧 Hubungi Kami</a>
            </div>
        </div>
    </div>
</div>
...
<div class="min-h-screen flex items-center justify-center px-4 py-12 relative overflow-hidden">
    ...
    <div class="relative z-10 text-center max-w-md">
        ...
        <div class="space-y-3">
            <a href="<?php echo e(route('home')); ?>" class="block px-8 py-3 bg-gradient-to-r from-red-600 to-orange-600 text-white font-bold rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300">
                Kembali ke Beranda
            </a>
            <a href="<?php echo e(route('contact')); ?>" class="block px-8 py-3 bg-white/10 dark:bg-white/5 border-2 border-white/20 text-gray-800 dark:text-white font-bold rounded-xl hover:bg-white/20 dark:hover:bg-white/10 transition-all duration-300">
                Hubungi Support
            </a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Laporan Tugas Kuliah\SEMESTER 4\Pemrograman Web Lanjut\hoaxchecker\resources\views/errors/404.blade.php ENDPATH**/ ?>