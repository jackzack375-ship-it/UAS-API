...
<?php $__env->startSection('title', 'HoaxChecker Indonesia — Verifikasi Berita dengan AI'); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
                ...
                <div class="flex flex-col sm:flex-row gap-4 mb-14 anim-up anim-up-4">
                    <a href="<?php echo e(route('hoax.check')); ?>" class="btn-primary text-base">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/>
                        </svg>
                        Cek Berita Sekarang
                    </a>
                    <a href="<?php echo e(route('education.index')); ?>" class="btn-secondary text-base">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="grid grid-cols-3 gap-6 anim-up" style="animation-delay: 0.5s;">
                    <?php $__currentLoopData = [['15K+', 'Berita Dianalisis', 'text-gradient'], ['92%', 'Akurasi Deteksi', 'text-gradient-blue'], ['8K+', 'Pengguna Aktif', 'text-gradient-danger']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$num, $label, $class]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div>
                        <div class="stat-number text-3xl md:text-4xl <?php echo e($class); ?>"><?php echo e($num); ?></div>
                        <p class="text-xs text-ink-400 mt-1 font-medium"><?php echo e($label); ?></p>
                    </div>
                ...
                <div class="relative">
                    ...
                    <div class="card-premium p-8 relative z-10">
                        ...
                        <div class="space-y-3 mb-6">
                            <?php $__currentLoopData = [['Sumber terverifikasi', true], ['Tidak ada manipulasi gambar', true], ['Konteks sesuai fakta', true], ['Tidak ada clickbait terdeteksi', true]]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$text, $pass]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center gap-3">
                                <div class="w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0"
                                     style="background: <?php echo e($pass ? 'rgba(16,185,129,0.2)' : 'rgba(239,68,68,0.2)'); ?>;">
                                    <div class="w-2 h-2 rounded-full" style="background: <?php echo e($pass ? '#10B981' : '#EF4444'); ?>;"></div>
                                </div>
                                <span class="text-sm text-ink-200"><?php echo e($text); ?></span>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
...
<div class="relative overflow-hidden py-4 border-y" style="border-color: rgba(0,0,0,0.06); margin: 0 -2rem;">
    ...
    <div class="flex gap-12 whitespace-nowrap" style="animation: ticker 30s linear infinite;">
        <?php $__currentLoopData = ['🛡️ Lawan Hoaks', '✦ 92% Akurasi AI', '🔍 Verifikasi Instan', '📚 Edukasi Digital', '🏆 8K+ Pengguna', '⚡ Real-time Analysis', '🤖 AI Canggih', '🌟 Gratis Selamanya']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <span class="text-sm font-medium text-ink-400 dark:text-ink-500 shrink-0"><?php echo e($item); ?></span>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php $__currentLoopData = ['🛡️ Lawan Hoaks', '✦ 92% Akurasi AI', '🔍 Verifikasi Instan', '📚 Edukasi Digital', '🏆 8K+ Pengguna', '⚡ Real-time Analysis', '🤖 AI Canggih', '🌟 Gratis Selamanya']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <span class="text-sm font-medium text-ink-400 dark:text-ink-500 shrink-0"><?php echo e($item); ?></span>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="card p-7 group">
            <div class="w-12 h-12 rounded-xl flex items-center justify-center text-2xl mb-5 transition-transform duration-300 group-hover:scale-110"
                 style="background: <?php echo e($f['color']); ?>18; border: 1px solid <?php echo e($f['color']); ?>30;">
                <?php echo e($f['icon']); ?>

            </div>
            <h3 class="font-display font-bold text-lg text-ink-900 dark:text-ink-50 mb-2"><?php echo e($f['title']); ?></h3>
            <p class="text-sm text-ink-500 dark:text-ink-400 leading-relaxed"><?php echo e($f['desc']); ?></p>
            <div class="mt-4 h-0.5 w-0 group-hover:w-full transition-all duration-500 rounded-full" style="background: linear-gradient(90deg, <?php echo e($f['color']); ?>, transparent);"></div>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
</section>
...
<section class="py-24 md:py-32 relative">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto relative">
        ...
        <div class="text-center group">
            ...
            <h3 class="font-display font-bold text-xl text-white mb-3"><?php echo e($step['title']); ?></h3>
            <p class="text-sm text-ink-400 max-w-xs mx-auto leading-relaxed"><?php echo e($step['desc']); ?></p>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>

    <div class="text-center mt-12">
        <a href="<?php echo e(route('hoax.check')); ?>" class="btn-primary">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="card p-8">
            ...
            <div class="flex items-center gap-3 pt-5 border-t" style="border-color: rgba(0,0,0,0.06);">
                ...
                <div>
                    <p class="font-semibold text-sm text-ink-900 dark:text-ink-50"><?php echo e($t['name']); ?></p>
                    <p class="text-xs text-ink-400"><?php echo e($t['role']); ?></p>
                </div>
            </div>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="space-y-3">
        ...
        <div x-data="{ open: false }" class="card overflow-hidden">
            ...
            <div x-show="open" x-transition class="px-6 pb-6 text-sm text-ink-500 dark:text-ink-400 leading-relaxed border-t" style="border-color: rgba(0,0,0,0.06);">
                <p class="pt-4"><?php echo e($faq['a']); ?></p>
            </div>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
...
<section class="py-20 border-y" style="border-color: rgba(0,0,0,0.06);">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
        <?php $__currentLoopData = [['Kominfo', '🏛️'], ['Cyber Lab', '🧪'], ['Media Watch', '📡'], ['EduTech Foundation', '🎓']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$name, $icon]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="card p-5 text-center group hover:border-yellow-300 dark:hover:border-yellow-600">
            <div class="text-3xl mb-2 transition-transform duration-300 group-hover:scale-110"><?php echo e($icon); ?></div>
            <p class="text-sm font-semibold text-ink-700 dark:text-ink-300"><?php echo e($name); ?></p>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
</section>
...
<section class="py-24 md:py-32">
    <div class="relative rounded-3xl overflow-hidden p-16 text-center" style="background: linear-gradient(135deg, #0D0D0D 0%, #1A1A1A 100%);">
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-4">
            <a href="<?php echo e(route('hoax.check')); ?>" class="btn-primary text-base px-8 py-4">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
                Mulai Cek Sekarang
            </a>
            <a href="<?php echo e(route('register')); ?>" class="btn-secondary text-base px-8 py-4" style="color: white; border-color: rgba(255,255,255,0.2);">
...
<section class="mb-10">
    <div class="relative rounded-2xl overflow-hidden p-10 text-center border" style="border-color: rgba(239,68,68,0.25); background: rgba(239,68,68,0.04);">
        ...
        <a href="<?php echo e(route('report.create')); ?>" class="btn-danger">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Laporan Tugas Kuliah\SEMESTER 4\Pemrograman Web Lanjut\hoaxchecker\resources\views/landing.blade.php ENDPATH**/ ?>